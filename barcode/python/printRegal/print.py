...
def print_placard():
    ...
    with open(r"C:\xampp\htdocs\dio\barcode\python\printRegal\outputKod.txt", 'r') as file:
        line = file.readline().strip()
        value = int(line)

    kod = str(value)
    with open(r"C:\xampp\htdocs\dio\barcode\python\printRegal\outputTekst.txt", 'r') as file:
        linija = file.readline().strip()
        txt = str(linija)
