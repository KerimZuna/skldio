...
<body>
    <div class="container mt-4">
        ...
        <div class="col-6">
                <div class="square">
                    <img style="max-height:100%; max-width:100%;" src="ikone/artikalpaleta.png" alt="Icon 1">
                    <h6>ARTIKAL - PALETA/REGAL</h6>
                </div>
            </div>
            <div class="col-6">
                <div class="square">
                    <img style="max-height:100%; max-width:100%;" src="ikone/regalkutija.png" alt="Icon 2">
                    <h6>PALETA/REGAL - PALETA/KUTIJA</h6>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="square">
                    <img style="max-height:100%; max-width:100%;" src="ikone/artikalkutija.png" alt="Icon 6">
