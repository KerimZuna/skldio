                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form action="save.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                               <input class="form-control" type="text" name="naziv" placeholder="Naziv vozila" required>
                            </div>
                           ...
                           <div class="col-md-12">
                                <input class="form-control" type="number" name="starost" placeholder="Starost" min="1" required>
                            </div>
                            ...
                            <div class="col-md-12">
                             ...
                             <div class="col-md-12">
                                <input class="form-control" type="number" name="godina" placeholder="Godina proizvodnje" min="2000" required>
                            </div>
                            <div class="col-md-12">
                                <input class="form-control" type="text" name="regbroj" placeholder="Registracijski broj" required>
                            </div>

                            <div class="col-md-12">
                                <input placeholder="Datum isteka registracije" class="form-control" type="text" onfocus="(this.type='date')" id="date" name="datum"/>
                            </div>
                        ...
                        <div class="col-md-8">
                            <input class="form-control" type="file" accept="image/*" name="licna_karta" id="licna_karta" placeholder="Lična karta" required>
                        </div>
                        ...
                        <div class="col-md-8">
                            <input class="form-control" type="file" accept="image/*" name="saobracajna_karta" id="saobracajna_karta" placeholder="Saobraćajna karta" required>
                        </div>
                        </div>

                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" value="" id="invalidCheck" required style="margin-top: 1.125rem;">
                          <label class="form-check-label" style="margin-left: 1.125rem;">Potvrđujem da su svi uneseni podaci ispravni</label>
                        </div>
                        ...
                        <div class="form-button d-flex justify-content-center mt-3">
                            ...
                            <button type="button" class="btn btn-dark btn-lg mx-2"><a href="table.php" >LISTA</a></button>
                        </div>
