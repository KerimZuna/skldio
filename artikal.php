...
<head>
    ...
    <title>WMS - AutoTarget - Dodaj artikal</title>
...
<body>
    <div class="col-md-6 well vh-100">
        <form method="POST" enctype="multipart/form-data" action="dodajartikal.php">
            <div class="form-group" style="margin-top:60px">
                <center><label for="broj">UNESITE BROJ ARTIKALA:</label></center>
                <br>
    ...
    <a href="unos.php">
        <center><button class="btn btn-primary mt-1 mb-2" name="nazad" style="width: 240px!important">NAZAD</button>
        </center>
    </a>
    <script>
        document.getElementById("dodaj").addEventListener("click", function (e) {
            ...
            if (selectedValue !== "Broj") {
                alert("Uspjesno ste dodali " + selectedValue + ' artikal/a');
            } else {
