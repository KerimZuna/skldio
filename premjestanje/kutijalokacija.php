...
<div class="col-md-6 well">
			<form method="POST" enctype="multipart/form-data" action="logika/kutijalokacija.php">
				<div class="form-group" style="margin auto">
					<center><label>UNESITE ID KUTIJE:</label></center>
					<br>
					<input type="number" class="form-control" name="id_kutije"/>
					<br/>
