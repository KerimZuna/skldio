...
<body>
    <div class="col-6 well">
        <form method="POST" enctype="multipart/form-data" action="logika/kutijaregal.php">
            <div class="row">
                <div class="col-8" id="inputFieldsContainer">
                    <input type="number" class="form-control mb-5" placeholder="Unesite kutiju" id="dodajKutiju">
            ...
            <label for="idRegala">ID Regala:</label>
            <input class="form-control mt-3" type="number" id="idRegala" name="idRegala"
                placeholder="Unesite id regala">
            <br><br>
    ...
    <script>
        ...
        document.getElementById("dodaj").addEventListener("click", function () {
            const dodajKutiju = document.getElementById("dodajKutiju");
            ...
            const inputValue = dodajKutiju.value.trim();
