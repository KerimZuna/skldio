...
<head>
    <link rel="stylesheet" type="text/css" href="kutija.css?=v2" />
    ...
    <div class="col-md-6 vh-100">
        <form method="POST" enctype="multipart/form-data" action="dodajhalu.php">
            <div class="form-group" style="margin-top: 100px">
                <center><label for="broj">UNESITE BROJ HALA</label></center>
                <br>
                ...
                <br>
                <center><button class="btn btn-primary w-100" name="dodaj" id="dodaj"
                        style="width: 220px!important">DODAJ</button></center>
                <br>
        </form>
    ...
    <script>
        document.getElementById("dodaj").addEventListener("click", function (e) {
            ...
            if (selectedValue !== "Broj") {
                alert("Uspjesno ste dodali " + selectedValue + ' halu/e');
            } else {
